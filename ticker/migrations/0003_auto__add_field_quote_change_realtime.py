...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.change_realtime'
        db.add_column(u'ticker_quote', 'change_realtime',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.change_realtime'
        db.delete_column(u'ticker_quote', 'change_realtime')
