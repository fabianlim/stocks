...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.last_trade_price'
        db.add_column(u'ticker_quote', 'last_trade_price',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.last_trade_price'
        db.delete_column(u'ticker_quote', 'last_trade_price')
    ...
    models = {
        ...
        u'ticker.quote': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'last_trade_price': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            u'stockrecord_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ticker.StockRecord']", 'unique': 'True', 'primary_key': 'True'}),
            'ticker': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ticker.Ticker']"}),
