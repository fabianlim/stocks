...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ticker_quote', (
            ...
            ('last_trade_date', self.gf('django.db.models.fields.DateField')()),
            ('last_trade_time', self.gf('django.db.models.fields.TimeField')()),
    ...
    models = {
        ...
        u'ticker.quote': {
            ...
            'last_trade_date': ('django.db.models.fields.DateField', [], {}),
            'last_trade_price': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'last_trade_time': ('django.db.models.fields.TimeField', [], {}),
